...
\begin{document}
	...
	\begin{tcolorbox}[flush right,breakable,colback=white,colframe=white,width=\contentlength]
		...
		\textit{Published or Accepted}
		\begin{enumerate}[itemsep=0mm]
			\item Jinyu Zhao, Haifeng Sun, Jingyu Wang, Qi Qi, Zirui Zhuang, Shimin Tao and Jianxin Liao. "CONFPILOT: A Pilot for Faster Configuration by Learning from Device Manuals." In \textit{2023 IEEE International Conference on Distributed Computing Systems} (ICDCS'23). Hongkong, China, 2023. \textit{Accepted.}
